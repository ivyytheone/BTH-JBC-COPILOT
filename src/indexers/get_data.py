import os
#This is not being used, since we use already indexed data. Just keeping this here, this could be redone maybe to keep previewing data in a seperate file insted of bundling it togheter.
